...
export const productTshirtData: (
  ...
  return {
    ...
    inventory: 0,
    meta: {
      title: 'KIKU Minimal Cotton Tee | KIKU',
      image: metaImage,
      description:
        'A minimal cotton tee refined for womenswear, cut close to the body with quietly elevated detailing.',
    },
    _status: 'published',
    layout: [
      {
                        ...
                        children: [
                          {
                            ...
                            mode: 'normal',
                            style: '',
                            text: 'This is a 100% cotton fitted tee cut for women with a clean crew neckline and refined proportions.',
                            type: 'text',
                            version: 1,
                          },
                          {
                                ...
                                children: [
                                  {
                                    ...
                                    mode: 'normal',
                                    style: '',
                                    text: 'Material: 100% cotton jersey',
                                    type: 'text',
                                    version: 1,
                                  },
                                ],
